...
RSpec.describe Idea do
  ...
  it "has a description" do # yep, you can totally use 'it'
    idea = Idea.create!(description: "My Awesome Description Name") # creating a new idea 'instance'
    expect(idea.description).to eq("My Awesome Description Name") # this is our expectation
  end
